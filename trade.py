...
stock_trader = EastMoneyTrader(driver,group='组合二',min_amount =100,commission_fee=0.0004,transaction_fee=0.0004)
stock_strategy = strategy_top_low_n(
    trader=stock_trader,
    data_dir=r'E:\data\trade_stock_small_market',
    topOrlow='top',
...
stock_strategy.trade()
zz1000_trader = EastMoneyTrader(driver,group='组合三',min_amount =100,commission_fee=0.0004,transaction_fee=0.0004)
zz1000_strategy = strategy_top_low_n(
    trader=zz1000_trader,
    data_dir=r'E:\data\trade_zz1000',
    topOrlow='top',
